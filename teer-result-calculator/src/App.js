      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-lg p-6 mb-6 sticky top-4 z-10">
          <div className="flex items-center justify-between flex-wrap gap-4 mb-4">
            ...
            <div className="bg-gradient-to-r from-green-500 to-emerald-600 text-white px-6 py-3 rounded-lg shadow-md">
              ...
              <div key={id} className="bg-white rounded-lg shadow-md hover:shadow-xl transition-shadow">
                ...
                >
                  <div className="flex items-center justify-between">
                    ...
                    <div className="text-right">
                      ...
                      <div className="font-bold">{formatCurrency(calc.total)}</div>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-4">
                  ...
                  {isExpanded && calc.entries.length > 0 && (
                    <div className="mb-3">
                      <div className="text-xs font-semibold text-gray-600 mb-2">Entries:</div>
